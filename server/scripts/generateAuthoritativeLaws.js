...
const authoritativeLaws = [
  ...
  // (Verified against public secondary reporting; numbers/dates re-checked
  // Sept 2026. Entries where a specific circular number could not be
  // independently confirmed were rewritten without inventing a citation —
  // see note in each entry's text.)
  // =========================================================================
  {
    ...
    "section": null,
    "subsection": null,
    "rule": "Order No. 38/2022, dated 13.12.2022",
    "title": "Non-negotiable clauses in the Agreement for Sale (carpet area confirmation and termination/refund clause)",
    "jurisdiction": "Maharashtra",
    "authority": "MahaRERA / Government of Maharashtra",
    "sourceUrl": "https://maharera.maharashtra.gov.in/",
    "text": "MahaRERA Order No. 38/2022, dated 13 December 2022. Non-negotiable clauses in the Agreement for Sale.— MahaRERA clarified that two specific clauses in the model form of Agreement for Sale at Annexure 'A' of Rule 10(1) of the Maharashtra RERA Rules, 2017 are not permitted to be modified and are non-negotiable, and must be incorporated as-is irrespective of what the promoter and allottee otherwise agree: (a) the promoter must confirm the final carpet area allotted to the allottee only after construction of the building is complete; (b) where the promoter fails to remedy breaches within the notice period given, the allottee is entitled to terminate the agreement and receive a refund, within thirty days of termination, of all instalments paid (subject to adjustment of any agreed liquidated damages). Any registered Agreement for Sale that varies or dilutes these two clauses is considered void ab initio and not binding on the allottee, and violation can lead to summary rejection of the project's registration application."
  },
  {
    "document": "MahaRERA Official Circulars & Orders",
    "actOrRule": "Order",
    "section": null,
    "subsection": null,
    "rule": "Order No. 31/2022, dated 01.07.2022 (superseding Order No. 30/2022)",
    "title": "Model Allotment Letter and tiered cap on booking-cancellation forfeiture",
    "jurisdiction": "Maharashtra",
    "authority": "MahaRERA / Government of Maharashtra",
    "sourceUrl": "https://maharera.maharashtra.gov.in/",
    "text": "MahaRERA Order No. 31/2022, dated 1 July 2022 (in supersession of Order No. 30/2022, dated 3 June 2022). Model Allotment Letter.— Where a promoter collects a deposit or advance of not more than 10% of the total consideration before a formal Agreement for Sale is signed, the promoter must issue an allotment letter in the format prescribed by MahaRERA's Model Allotment Letter. This format prescribes a tiered cap on how much the promoter may forfeit if the booking is cancelled by the allottee (or by the promoter for the allottee's non-payment): full refund if cancelled within 15 days of the allotment letter; up to 1% deduction if cancelled 16-30 days after issuance; up to 1.5% if cancelled 31-60 days after issuance; up to 2% if cancelled after 61 days. A promoter may only vary this format to extend the cancellation window or reduce the forfeiture percentage in the allottee's favour, never the reverse. Deviations from the model format in the Agreement for Sale must be highlighted in a different colour for ease of verification."
  },
  {
    "document": "MahaRERA Official Circulars & Orders",
    "actOrRule": "Order",
    "section": null,
    "subsection": null,
    "rule": "Order No. 56/2024, dated 27.06.2024",
    "title": "Three mandatory RERA project bank accounts (100% / 70% / 30% structure) for projects registered on or after 1 July 2024",
    "jurisdiction": "Maharashtra",
    "authority": "MahaRERA / Government of Maharashtra",
    "sourceUrl": "https://maharera.maharashtra.gov.in/",
    "text": "MahaRERA Order No. 56/2024, dated 27 June 2024. Maintenance and operation of RERA project bank accounts.— For projects registered with MahaRERA on or after 1 July 2024, the promoter must open three separate bank accounts in the same scheduled bank before applying for project registration: (1) a RERA Designated Collection Bank Account, into which 100% of amounts collected from allottees are first deposited; (2) a RERA Designated Separate Bank Account (the statutory 70% account under Section 4(2)(l)(D) of the RERA Act), to be used only for land and construction costs of that project; (3) a RERA Designated Transaction Bank Account (the remaining 30%), which is not itself regulated by RERA and may be used more freely by the promoter. Funds must auto-sweep from the Collection Account into the 70%/30% split; no direct withdrawals by cheque, card, or other instrument are permitted from the Collection Account. Withdrawals from the 70% account remain subject to the existing requirement of Form 1 (architect's certification of physical progress), Form 2 (engineer's certification of costs incurred), and Form 3 (chartered accountant's certification of proportionate, admissible withdrawal), consistent with MahaRERA Rules 2017, Rule 5."
  },
  {
    "document": "MahaRERA Official Circulars & Orders",
    "actOrRule": "Circular",
    "section": null,
    "subsection": null,
    "rule": "General MahaRERA administrative practice (specific circular number not independently verified — treat as indicative, not a precise citation)",
    "title": "Parking space allocation: open parking is a common area, not independently saleable",
    "jurisdiction": "Maharashtra",
    "authority": "MahaRERA / Government of Maharashtra",
    "sourceUrl": "https://maharera.maharashtra.gov.in/",
    "text": "MahaRERA guidance on parking allocation (general administrative position, exact circular/order number not confirmed in this corpus — verify current wording directly on the MahaRERA portal before relying on it for a specific dispute).— Open (uncovered) parking spaces are treated as part of a project's common areas under the RERA Act's definition of common areas, and MahaRERA's consistent administrative position is that promoters should not sell or separately price open parking spaces as if they were independently transferable units; they are to be made available to the Association of Allottees along with the other common areas. Covered or stilt parking, by contrast, can generally be allotted/sold where it is clearly demarcated with a specific number, floor and dimensions in the sanctioned layout plan and the registered Agreement for Sale — a sale agreement that separately prices an unnumbered or undemarcated \"open parking\" slot is worth flagging for closer review."
  },
  ...
  // =========================================================================
  {
    "document": "Hindu Succession Act, 1956",
    "actOrRule": "Act",
    "section": "8",
    "subsection": null,
    "rule": null,
    "title": "General rules of succession in the case of a Hindu male dying intestate (Class I heirs)",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/1998",
    "text": "Hindu Succession Act, 1956, Section 8. General rules of succession in the case of males.— The property of a Hindu male dying intestate shall devolve firstly upon the heirs, being the relatives specified in Class I of the Schedule (which includes the widow, sons, daughters, and mother, among others), who take the property simultaneously and to the exclusion of all other heirs; in the absence of any Class I heir, the property devolves upon Class II heirs, and thereafter upon agnates and cognates in the order specified by the Act. Where a property being sold traces its title through intestate succession, the vendor's exclusive title should be verified against the complete set of Class I heirs and their respective shares, since a sale without the consent or release of a rightful heir can later be challenged."
  },
  {
    "document": "Hindu Succession Act, 1956",
    "actOrRule": "Act",
    "section": "6",
    "subsection": "as amended by the Hindu Succession (Amendment) Act, 2005",
    "rule": null,
    "title": "Daughters as coparceners by birth in Mitakshara joint family property",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/1998",
    "text": "Hindu Succession Act, 1956, Section 6 (as amended in 2005). Devolution of interest in coparcenary property.— On and from the commencement of the Hindu Succession (Amendment) Act, 2005, the daughter of a coparcener in a Hindu Mitakshara joint family shall, by birth, become a coparcener in her own right in the same manner as a son, and shall have the same rights in the coparcenary property, and be subject to the same liabilities, as a son. This gives daughters equal inheritance rights in ancestral property retrospectively from birth, which is a frequent point of dispute in older family-owned properties being sold — a sale executed without the consent of, or a registered release/relinquishment from, all daughters who are coparceners is vulnerable to later challenge."
  },

  // =========================================================================
  // 10. INDIAN EASEMENTS ACT, 1882
  // =========================================================================
  {
    "document": "Indian Easements Act, 1882",
    "actOrRule": "Act",
    "section": "15",
    "subsection": null,
    "rule": null,
    "title": "Acquisition of easement by prescription (right of way, light, air, support)",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2352",
    "text": "Indian Easements Act, 1882, Section 15. Acquisition by prescription.— Where a right of way, or a right to light, air, or support, or any other easement, has been peaceably and openly enjoyed as an easement, and as of right, without interruption, for twenty years (sixty years where the property over which the right is claimed belongs to the Government), the right becomes absolute. This is distinct from adverse possession, since it creates a right to use land for a specific purpose (such as access via a shared driveway) rather than ownership of the land itself, and is relevant whenever a property's access route, shared passage, or light/ventilation depends on crossing or facing a neighbouring plot."
  },

  // =========================================================================
  // 11. LIMITATION ACT, 1963 — ADVERSE POSSESSION
  // =========================================================================
  {
    "document": "Limitation Act, 1963",
    "actOrRule": "Act",
    "section": "27, Article 65 of the Schedule",
    "subsection": null,
    "rule": null,
    "title": "Extinguishment of the true owner's right after 12 years of adverse possession",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/1706",
    "text": "Limitation Act, 1963, Section 27 read with Article 65 of the Schedule. Extinguishment of right to property.— A suit for possession of immovable property based on title must be filed within twelve years from when the possession of the defendant becomes adverse to the plaintiff; at the expiry of that period, the true owner's right to reclaim private property from a person in continuous, open, exclusive and hostile possession is extinguished (thirty years applies instead for government-owned land). Permissive possession, such as an ordinary tenancy, does not count as 'hostile,' and the burden of proving every element of adverse possession falls entirely on the person claiming it — relevant when reviewing a property with a long history of a non-owner occupant, such as an old tenant, encroacher, or family member in undisputed possession for many years."
  },
  ...
  // =========================================================================
  {
    "document": "Securitisation and Reconstruction of Financial Assets and Enforcement of Security Interest (SARFAESI) Act, 2002",
    "actOrRule": "Act",
    "section": "13(2), 13(3A), 13(4), 17",
    "subsection": null,
    "rule": null,
    "title": "Bank/lender enforcement of secured assets without court intervention, borrower's right to object and appeal to the DRT",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2011",
    "text": "SARFAESI Act, 2002, Sections 13(2), 13(3A), 13(4) & 17. Enforcement of security interest.— Once a secured debt (such as a home loan) is classified as a Non-Performing Asset (typically after 90 days of default under RBI norms), the secured creditor may issue a written demand notice under Section 13(2) requiring repayment within 60 days, without first approaching a court. The borrower may make a representation objecting to the notice under Section 13(3A), which the creditor must consider and respond to with reasons if rejected. If dues remain unpaid after the notice period, the creditor may, under Section 13(4), take possession of the secured asset and sell it to recover the outstanding amount. The borrower (or any aggrieved person) may appeal the creditor's action to the Debts Recovery Tribunal under Section 17, generally within 45 days of the measure being taken. This is directly relevant when reviewing a resale property still under an active home loan: the seller's bank must release its charge/issue a no-objection before a clean, unencumbered sale can be completed, and a property being sold following a SARFAESI auction carries a different, generally higher, risk profile than an ordinary resale."
  },

  // =========================================================================
  // 13. FOREIGN EXCHANGE MANAGEMENT ACT (FEMA), 1999 — NRI/OCI PROPERTY RULES
  // =========================================================================
  {
    "document": "Foreign Exchange Management Act, 1999 (FEMA) — Acquisition and Transfer of Immovable Property in India Regulations",
    "actOrRule": "Act/Regulations",
    "section": null,
    "subsection": null,
    "rule": "FEMA (Acquisition and Transfer of Immovable Property in India) Regulations",
    "title": "Rules governing NRI and OCI purchase of residential/commercial property, and the prohibition on agricultural land",
    "jurisdiction": "India",
    "authority": "Reserve Bank of India / India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2093",
    "text": "FEMA, 1999, read with the RBI's Acquisition and Transfer of Immovable Property in India Regulations.— A Non-Resident Indian (NRI) or Overseas Citizen of India (OCI) may purchase any number of residential or commercial properties in India without RBI approval, provided payment is made through normal banking channels (NRE, NRO, or FCNR accounts) and not in cash or foreign currency notes. NRIs and OCIs are, however, strictly prohibited from purchasing agricultural land, plantation property, or farmhouses — even through a company or a resident relative acting on their behalf — though such property may still be inherited from a resident Indian relative. Violations are enforced seriously: the RBI has, in reported cases, imposed compounding penalties of up to three times the purchase price on NRIs who bought agricultural land, even years after the purchase and despite the buyer's later cooperation once discovered. Any agreement where an NRI/OCI buyer is acquiring land described as agricultural, or where the land-use classification is unclear, warrants specific verification before proceeding."
  },
  ...
  // =========================================================================
  {
    "document": "Insolvency and Bankruptcy Code, 2016",
    "actOrRule": "Act",
    "section": "5(8)(f)",
    "subsection": "as amended in 2018",
    "rule": null,
    "title": "Homebuyers/allottees treated as financial creditors of a defaulting developer",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2154",
    "text": "Insolvency and Bankruptcy Code, 2016, Section 5(8)(f) (as amended in 2018). Financial debt — amounts raised having the commercial effect of a borrowing.— Following the 2018 amendment, any amount a homebuyer has paid to a developer for an under-construction unit is deemed to have the commercial effect of borrowing, which makes the homebuyer a financial creditor of the developer for the purposes of insolvency proceedings. This lets a class of homebuyers initiate or participate in insolvency proceedings against a defaulting developer and gives them voting representation on the committee of creditors — a right the Supreme Court upheld as constitutional in Pioneer Urban Land and Infrastructure Ltd. v. Union of India (2019). This is relevant when a project has stalled and the buyer is weighing legal options against an insolvent or financially troubled builder, as an alternative or complement to a RERA complaint."
  },

  // =========================================================================
  // 15. GENERAL POWER OF ATTORNEY SALES — SUPREME COURT POSITION
  // =========================================================================
  {
    "document": "Suraj Lamp & Industries Pvt. Ltd. v. State of Haryana (Supreme Court of India, 2012) — SA/GPA/Will transfers",
    "actOrRule": "Judicial precedent (interpreting the Transfer of Property Act, 1882 and Registration Act, 1908)",
    "section": null,
    "subsection": null,
    "rule": null,
    "title": "GPA-based 'sales' (Sale Agreement + General Power of Attorney + Will) do not transfer ownership of immovable property",
    "jurisdiction": "India",
    "authority": "Supreme Court of India",
    "sourceUrl": "https://main.sci.gov.in/",
    "text": "Suraj Lamp & Industries Pvt. Ltd. v. State of Haryana, (2012) 1 SCC 656.— The Supreme Court held that the practice of transferring immovable property through a combination of a sale agreement, a general power of attorney, and a will (\"SA/GPA/Will\" transactions), used as a substitute for a registered sale deed, does not convey title or create any interest in immovable property, and is not a recognised mode of transfer under the Transfer of Property Act, 1882. Only a registered conveyance deed, executed and registered under the Registration Act, 1908, can legally transfer ownership of immovable property valued above the statutory threshold. A property represented as 'sold' only through a GPA (a pattern historically used to avoid stamp duty and registration charges) therefore carries serious, unresolved title risk for the person in possession, since the legal owner on record has never actually changed."
  },

  // =========================================================================
  // 16. INCOME TAX — TDS ON PROPERTY PURCHASE AND GST ON UNDER-CONSTRUCTION PROPERTY
  // =========================================================================
  {
    "document": "Income-tax Act (TDS on immovable property transactions)",
    "actOrRule": "Act",
    "section": "194-IA of the Income-tax Act, 1961 (carried forward as Section 393 of the Income-tax Act, 2025, effective from April 2026)",
    "subsection": null,
    "rule": "Form 26QB / Form 16B",
    "title": "1% TDS obligation on a buyer purchasing property worth Rs. 50 lakh or more",
    "jurisdiction": "India",
    "authority": "Income Tax Department, Government of India",
    "sourceUrl": "https://www.incometax.gov.in/",
    "text": "TDS on transfer of certain immovable property (Section 194-IA of the Income-tax Act, 1961, carried forward in substance as Section 393 of the Income-tax Act, 2025, effective from 1 April 2026).— A buyer purchasing immovable property (other than agricultural land) for a consideration of Rs. 50 lakh or more must deduct 1% of the sale consideration as TDS at the time of payment, deposit it with the government using Form 26QB, and issue Form 16B to the seller as proof of deduction. Failing to deduct or deposit this TDS exposes the buyer to interest and penalty, even though the underlying sale transaction itself remains valid — worth flagging as a compliance step distinct from stamp duty and registration."
  },
  {
    "document": "Central Goods and Services Tax (GST) Act, 2017 — real estate notifications",
    "actOrRule": "Act/Notification",
    "section": null,
    "subsection": null,
    "rule": "GST rates on real estate (effective post-April 2019 scheme)",
    "title": "GST applicability on under-construction property versus completed/ready-to-move property",
    "jurisdiction": "India",
    "authority": "Central Board of Indirect Taxes and Customs, Government of India",
    "sourceUrl": "https://www.cbic.gov.in/",
    "text": "GST on real estate transactions.— A property attracts GST only while it is under construction and sold before receipt of the completion or occupancy certificate. The applicable rate (without input tax credit) is 1% for affordable housing meeting the prescribed size and price criteria, and 5% for other residential units. A completed, ready-to-move-in property sold after the completion certificate has been issued attracts no GST at all — only stamp duty and registration charges apply. Confirming whether the completion certificate has actually been issued (rather than relying on the seller's or agent's characterization of the property as 'ready') is therefore directly relevant to the buyer's total cost."
  },

  // =========================================================================
  // 17. PROHIBITION OF BENAMI PROPERTY TRANSACTIONS ACT, 1988
  // =========================================================================
  {
    "document": "Prohibition of Benami Property Transactions Act, 1988 (as amended by the Benami Transactions (Prohibition) Amendment Act, 2016)",
    "actOrRule": "Act",
    "section": "2(9), 3, 5",
    "subsection": null,
    "rule": null,
    "title": "Prohibition on holding property in another person's name (benami transactions) and confiscation/prosecution consequences",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2103",
    "text": "Prohibition of Benami Property Transactions Act, 1988 (as amended 2016).— It is illegal to purchase or hold property in the name of another person (a 'benami' transaction) while the real purchaser provides the funds and enjoys the benefits of the property, subject to limited statutory exceptions such as property held for a spouse or child, or held by a person in a fiduciary capacity such as a trustee or a Karta of a Hindu Undivided Family for its members. A property found to be benami can be confiscated by the government under Section 5, and both the person who provided the funds and the person whose name was used can face criminal prosecution. Worth checking when a property's funding source and the name on title don't obviously match, or where a family member's name is on the deed for a purchase actually funded by someone else."
  },

  // =========================================================================
  // 18. CONSUMER PROTECTION ACT, 2019 — PARALLEL REMEDY TO RERA
  // =========================================================================
  {
    ...
    "subsection": null,
    "rule": null,
    "title": "Home buyer as a 'consumer' with a parallel remedy against builder deficiency of service, alongside RERA",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/15256",
    "text": "Consumer Protection Act, 2019.— A home buyer qualifies as a 'consumer' under Section 2(7) and may file a complaint against a builder or developer before the appropriate Consumer Commission (District, State, or National, based on the value of the claim) for 'deficiency in service,' such as poor construction quality, non-delivery of promised amenities, or unfair contract terms. This remedy is available in parallel with, and not instead of, a RERA complaint — the RERA Act's Section 88 explicitly preserves other legal remedies, and RERA's Section 79 bar on civil courts does not extend to Consumer Commissions. In practice, RERA authorities are generally the more specialised forum for project-specific issues like delayed possession, while Consumer Commissions are often used for construction-quality and service-deficiency disputes, or where the buyer also seeks compensation for mental agony/harassment, which Consumer Commissions can award."
  },

  // =========================================================================
  // 19. SPECIFIC RELIEF ACT, 1963 (AS AMENDED 2018)
  // =========================================================================
  {
    "document": "Specific Relief Act, 1963 (as amended by the Specific Relief (Amendment) Act, 2018)",
    "actOrRule": "Act",
    "section": "10, 20",
    "subsection": "as substituted/amended in 2018",
    "rule": null,
    "title": "Specific performance of a property sale agreement is now the general rule, not a discretionary exception",
    "jurisdiction": "India",
    "authority": "India Code",
    "sourceUrl": "https://www.indiacode.nic.in/handle/123456789/2075",
    "text": "Specific Relief Act, 1963, Section 10 (as substituted by the 2018 Amendment).— Prior to the 2018 amendment, specific performance of a contract (compelling the actual completion of a property sale, rather than only awarding damages) was a discretionary remedy the court could refuse even where the contract was otherwise valid. Following the 2018 amendment, Section 10 now provides that specific performance of a contract shall be enforced by the court subject only to the limited exceptions listed elsewhere in the Act (such as Section 14), making it the default/general rule rather than a discretionary exception. This is a materially stronger remedy for a buyer whose seller (or a developer) refuses to complete an otherwise valid, binding agreement for sale — the buyer is no longer solely reliant on convincing a court that damages alone would be an inadequate remedy."
  }
];
